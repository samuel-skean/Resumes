...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \begin{itemize}
        \item \textbf{Relevant Coursework}: Cloud Computing, Operating Systems, Compilers.
      \end{itemize}
    \resumeSubheading
      {University of Illinois at Chicago}{Chicago, IL}
      ...
      \begin{itemize}
        ...
        \item \textbf{Relevant Coursework}: Systems Programming, Data Structures, Programming Language Design, Principles of Concurrent Computing, Systems Performance and Concurrent Computing, Graphics, Web App Development.
      \end{itemize}
    % \resumeSubheading
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Motivated and explained understand database (SQL), functional (F\#), and concurrent (Go) programming}
        \resumeItem{Leads students in debugging simple embedded projects in C on Arduino}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Coordinated with managers to help with everything from enrollment to software troubleshooting}

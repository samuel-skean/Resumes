...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: Ansible, Git, JavaFX, React.js, Flutter, Hadoop, Spark, Axum (Rust web framework), Matplotlib, WebGL2, p5.js} \\
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {CS Teaching Assistant (Undergrad and Grad)}{January 2023 -- December 2024}
      {UIC}{Chicago, IL}
      \resumeItemListStart
        \resumeItem{\textbf{5} semesters of teaching experience, helping over 50 students personally}
        \resumeItem{Explained data structures in \textbf{C++}; and motivated \textbf{SQL}, \textbf{F\#}, and \textbf{Go} programming}
        \resumeItem{Graded and proctors exams and labs, giving short lessons on related topics}

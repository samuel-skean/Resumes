...
\begin{center}
    \textbf{\Huge \scshape Samuel Skean} \\ \vspace{1pt} \href{mailto:skeansamuel64@gmail.com}{\uline{skeansamuel64@gmail.com}} $|$ 
    \href{https://www.linkedin.com/in/samuel-skean-nod}{\uline{linkedin.com/in/samuel-skean-nod}} $|$ \href{https://samuel-skean.net}{\uline{samuel-skean.net}}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.S. + Pursuing Master's in Computer Science}{Aug. 2020 -- B.S. Earned May 2024 -- Left December 2025}
      \begin{itemize}
        \item \textbf{Undergraduate GPA}{: \emph{Major:} 4.0 \emph{Overall:} 3.93} \quad \quad \textbf{Graduate GPA}{: 3.85}
        \item \textbf{Relevant Coursework}: Databases, Networking, Operating Systems, Systems Performance, Concurrent Computing, Compilers, Interpreters, Provably Correct Programming, Web App Development, Data Structures, Algorithms, Cloud Computing, Graphics
      \end{itemize}
    % \resumeSubheading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Rust, C/C++, Java, C\verb|#|, Dart, Swift, Go, Python, SQL (SQLite + PostgreSQL), JavaScript, HTML/CSS, F\verb|#|, OCaml, Bash, AWK, x86 Assembly} \\
     \textbf{Other Tools}{: Ansible, Wireshark, Git, JavaFX, React.js, Flutter, Axum (Rust web framework), WebGL2} \\
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {CS Research Assistant (Grad)}{May 2025 -- August 2025}
      {UIC}{Chicago, IL}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
    \resumeSubheading
      {Student Ambassador for National Science Foundation Engineering Scholarship}{August 2024, July 2025}
      {UIC}{Chicago, IL}
      \resumeItemListStart
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{\href{https://github.com/samuel-skean/My_Raytracing_Adventures.git}{\uline{Path Tracer}} and \href{https://github.com/samuel-skean/SkeanSplinesFun.git}{\uline{Bezier Drawer}}} $|$ \emph{Rust, pixels, winit, serde}}{February 2024 -- August 2024}
          \resumeItemListStart
            \resumeItem{Rendered spheres, planes, and reflections, mostly following \href{https://raytracing.github.io/books/RayTracingInOneWeekend.html}{\uline{Raytracing in One Weekend by Peter Shirley et al.}}}
          ...
          \resumeItemListEnd
        \resumeProjectHeading
          {\textbf{\href{https://github.com/samuel-skean/xv6-public/tree/hw4-mmap}{\uline{MMap and Other Extensions for XV6}}} $|$ \emph{C}}{September 2024}
          \resumeItemListStart
        ...
        \newpage
        \resumeProjectHeading
          {\textbf{\href{https://github.com/samuel-skean/mark_and_sweep_garbage_collector_in_c}{\uline{Tracing Garbage Collector}}} $|$ \emph{C}}{December 2022}
          \resumeItemListStart
          ...
          \resumeItemListEnd
        \resumeProjectHeading
          {\textbf{\href{https://github.com/samuel-skean/FifteenPuzzle}{\uline{15-Puzzle Graphical Game}}} $|$ \emph{Java, JavaFX}}{November 2021}
          \resumeItemListStart

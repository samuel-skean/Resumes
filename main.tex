...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {UIC}{Chicago, IL}
      \resumeItemListStart
        \resumeItem{5 semesters of teaching experience, helping over \textbf{50} students personally}
        \resumeItem{Motivated and explained data structures in \textbf{C++}; and \textbf{SQL}, \textbf{F\#}, and \textbf{Go} programming}
